...
if(isset($_POST['submit']))
{
	...
	$status=1;
	$query=mysqli_query($con,"insert into users(fullName,userEmail,matricno,department,password,contactNo,status) values('$fullname','$email','$matricno','$department','$password','$contactno','$status')");
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		         <input type="text" class="form-control" placeholder="Full Name" name="fullname" required="required" autofocus>
					...
					<br>
					<input type="text" class="form-control" placeholder="MATRIC-NO" id="matricno" onBlur="userAvailability()" name="matricno" required="required">
		             <span id="user-availability-status1" style="font-size:12px;"></span>
					<br>
					<input type="text" class="form-control" placeholder="DEPARTMENT" id="department" onBlur="userAvailability()" name="department" required="required">
		             <span id="user-availability-status1" style="font-size:12px;"></span>
		            <br>
